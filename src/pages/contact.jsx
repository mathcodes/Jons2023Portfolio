    ...
    <>
      ...
      <SimpleLayout title="Get in touch today!">
        <div className="container contact" style={{ padding: '20px', maxWidth: `768px` }}>
          <h1 className="text-4xl font-bold text-zinc-800 dark:text-zinc-100 font-bold">As a Software Developer & Trainer...</h1>
          <h5 className="container contact text-black-800 font-bold transition dark:text-zinc-100 font-bold" style={{ padding: '20px', maxWidth: `768px` }}>... I am excited to connect with potential opportunities and collaborations. With over a 5+ years of experience as a front-end developer, I have worked extensively with JavaScript, TypeScript, React, React Native, WordPress, SquareSpace, HTML, CSS, PHP, Python and more, including libraries and frameworks   to enhance and create websites for clients.
            <br />
            <br />
