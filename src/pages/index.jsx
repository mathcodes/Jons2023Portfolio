        ...
        {resume.map((role, roleIndex) => (
          <li key={roleIndex} className="flex gap-4">
            ...
            <dl className="flex flex-auto flex-wrap gap-x-2">
              ...
              <dd className="w-full flex-none text-sm font-medium text-zinc-900 dark:text-zinc-100 font-bold">
                {role.company}
              </dd>
              ...
              <dd
                className="ml-auto text-xs text-zinc-800 dark:text-zinc-100 font-bold"
    ...
    <>
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-00 dark:text-zinc-100 font-bold sm:text-5xl">
